...
lam  = 2.5 # Slope
#original_pdf = stats.expon(lam)
original_pdf = stats.expon()

# Here's the original function as x,y points
x = np.linspace(-1,5.0,npts)
y = (lam)*original_pdf.pdf(lam*x) # Normalized exponential.
