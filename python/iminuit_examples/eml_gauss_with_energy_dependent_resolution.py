...
wt0 = []
for xpt in x:
    wt0.append(np.random.normal(2.0,0.2*xpt*xpt*xpt*xpt*xpt))
...
plt.figure()
plt.hist(wt0[x<1.5],bins=50,range=(-5,5),alpha=0.8,normed=True)
plt.hist(wt0[x>1.5],bins=50,range=(-5,5),alpha=0.2,normed=True)
