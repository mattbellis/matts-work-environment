...
echo "#####################"
#date; time $executable $data $data $global_params -o "$tag"_"$ngals"k_data_data_arcmin.dat -d 0 >& log0.log &
date; time $executable $flat $flat $global_params -o "$tag"_"$ngals"k_flat_flat_arcmin.dat -d 1 >& log1.log &
wait
