...
void rf312_multirangefit_modified()
{
  ...
  RooRealVar n0("n0","n0",2000,0,10000);
  RooRealVar n1("n1","n1",8000,0,10000);
  RooAddPdf model("model","model",RooArgList(sig,bkg),RooArgList(n0,n1)) ;
