...
if ( $1 == "push" ) then
    ...
    rsync -P -r -u -a -v mattbellis.dyndns-home.com:/home/bellis/{Talks,Work,NIU,BaBar,Jobs,stuff,papers,latex_stuff,bluehost_staging,Stanford,python_packages,eBooks,wallpapers,printer_drivers} \
        /home/bellis
