...
def generate(env):
    ...
    try:
        ...
        paths=['/nfs/slac/g/ki/ki06/lsst/djbard/LSST/GPU/cuda', home + '/NVIDIA_CUDA_TOOLKIT',
    ...
    try:
        ...
        paths=['/nfs/slac/g/ki/ki06/lsst/djbard/LSST/GPU/SDK', home + '/NVIDIA_CUDA_SDK', # i am just guessing here
    ...
    env.Append(LIBPATH=[cudaSDKPath + '/lib', cudaSDKPath + '/common/lib' + cudaSDKSubLibDir, cudaToolkitPath + '/lib64'])
