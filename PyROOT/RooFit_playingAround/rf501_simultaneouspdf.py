...
rllist.Add(RooFit.Cut("sample==sample::physics"))
combData.plotOn(frame1, rllist)
print "Plotted the physics sample"
...
rllistctl = RooLinkedList()
rllistctl.Add(RooFit.Cut("sample==sample::control"))
combData.plotOn(frame2, rllistctl)
print "Plotted the control sample"
