...
################################################################################
set ntp = $1
#python run_a_set_of_fits.py --my-python $MY_PYTHON --ntp $ntp --baryon Lambda0 --pass 0 --step 2
python run_a_set_of_fits.py --my-python $MY_PYTHON --ntp $ntp --baryon Lambda0 --pass 0 --step 3
