...
rooargs = RooArgSet(z)
mcstudy = RooMCStudy(rhp, rooargs, \
...
filename = "%s/mcstudies_testing_%s.dat" % ( "test", "%04d")
#mcstudy.generate(3, 500, kTRUE, filename)
mcstudy.generate(3, 500, kTRUE)

dumdata = mcstudy.genData(0)
print dumdata
print dumdata.numEntries()
