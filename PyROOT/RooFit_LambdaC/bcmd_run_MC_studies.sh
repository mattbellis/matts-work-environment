...
echo python run_a_set_of_fits.py --my-python $MY_PYTHON --ntp $ntp --baryon $baryon --pass 1 --step 4 \
                            $p_or_e \
                            --num-sig $nsig \
                            $fixed_num $dim0 $dim1 $no_gc \
                            --num-fits 1000 \
                            --sideband-first


python run_a_set_of_fits.py --my-python $MY_PYTHON --ntp $ntp --baryon $baryon --pass 1 --step 4 \
                            $p_or_e \
                            --num-sig $nsig \
                            $fixed_num $dim0 $dim1 $no_gc \
                            --num-fits 1000 \
