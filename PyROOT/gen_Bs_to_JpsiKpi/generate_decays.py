...
# B- --> A B C
masses0 = array('d', [ m_Jpsi, m_kc, m_pic  ])
n0 = len(masses0)
...
def Bdecay():
    ...
    if event0.SetDecay(initial_B, n0, masses0, ""):
        ...
        p_k = event0.GetDecay(1) # This returns a TLorentzVector
        p_pi = event0.GetDecay(2) # This returns a TLorentzVector

        kaons.append([p_k.E(),p_k.Px(),p_k.Py(),p_k.Pz(),-1])
        pions.append([p_pi.E(),p_pi.Px(),p_pi.Py(),p_pi.Pz(),+1])
...
# Generate the events!
outfilename = "ToyMC_LHCb_BtoJpsiKpi.dat"
#outfilename = "ToyMC_LHCb_BtoJpsiKpi_0.5pct_resolution_100k.dat"
#outfilename = "ToyMC_LHCb_BtoJpsiKpi_0.5pct_resolution_1M.dat"
