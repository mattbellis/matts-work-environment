...
foreach flag(0 1 2)
    ...
    python2.7 read_in_from_text_file.py data/before_fire_LG.dat -b --cg-mod --sig-mod --bkg-mod --e-lo 0.5 --e-bins 108 --add-gc --gc-flag $flag > log_elo5_bkg_and_sig_and_mod_add_gc_gc_flag$flag.log
